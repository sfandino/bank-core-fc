...
dependencies {
    ...
    // Guava -- TODO CF delete if not needed after finishing (was included in the original project)
...
// Task to start the Quartz scheduler 
tasks.register<JavaExec>("runQuartzScheduler") {
  group = "scheduling"
  description = "Start the Quartz scheduler"
  classpath = sourceSets["main"].runtimeClasspath
  mainClass.set("com.bankcore.reporting.QuartzReportingAppKt")
}